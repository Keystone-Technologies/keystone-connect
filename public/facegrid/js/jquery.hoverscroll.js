...
$.fn.hoverscroll = function(params) {
	...
	this.each(function() {
		...
		if (params.arrows) {
			if (!params.vertical) {
                if (params.fixedArrows) {
                    leftArrow = '<div class="fixed-arrow left fa fa-angle-left"></div>';
                    rightArrow = '<div class="fixed-arrow right fa fa-angle-right"></div>';

                    listctnr.before(leftArrow).after(rightArrow);
                }
                else {
                    leftArrow = '<div class="arrow left fa fa-angle-left"></div>';
                    rightArrow = '<div class="arrow right fa fa-angle-right"></div>';
